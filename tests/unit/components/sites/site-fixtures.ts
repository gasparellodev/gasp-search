/**
 * Fixtures compartilhadas para os testes de `components/sites/*` (#161, #197).
 *
 * **v2 (issue #197)**: nested `brand_assets` + `address` estruturado +
 * `schema_version: 2`. Tests que querem flat v1 devem usar
