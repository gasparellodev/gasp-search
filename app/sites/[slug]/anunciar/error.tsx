...
export default function AnunciarError({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      console.error("[site:anunciar:boundary]", error);
    }
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
        Não conseguimos carregar a página de anúncio
      </h1>
